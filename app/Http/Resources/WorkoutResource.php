...
final class WorkoutResource extends JsonResource
{
     ...
     * - Последние 3 завершенные тренировки, завершённые ДО начала текущей (finished_at != null)
     * 
     * Использует предзагруженные данные из контроллера для оптимизации производительности.
     * Данные уже отфильтрованы на уровне контроллера: включены только тренировки,
     * завершённые до начала текущей, что исключает попадание будущих подходов в историю.
     * 
