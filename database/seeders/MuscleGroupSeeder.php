...
final class MuscleGroupSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $muscleGroups = [
            ...
            ['name' => 'Руки', 'size_factor' => 0.6, 'optimal_frequency_per_week' => 2],
            ['name' => 'Ноги', 'size_factor' => 2.0, 'optimal_frequency_per_week' => 1],
            ['name' => 'Пресс', 'size_factor' => 0.5, 'optimal_frequency_per_week' => 3],
